...
const { getAllScreams, postOneScream, getScream, postCommentScream, likeScream, unlikeScream, deleteScream } = require('./handlers/screams');
const { signup, login, uploadImage, addUserDetails, getUserData, getUserDetails, markNotificationsRead } = require('./handlers/users');
